...
const requiredCopy=[
  ...
  'Premium Labs · access preview','Advanced labs with a real entitlement model.','Diffusion & b-Value Lab','Parallel Imaging Lab','RF Power Concepts Lab','Gradient Encoding Concepts Lab','No charges are active in v11.5.',
...
if(!sw.includes("mrcc-v11.5.0")) fail.push('Service worker cache marker is not v11.5.0.');
...
if(!html.includes('/* v10.2 Live release identity + navigation */')||!html.includes('class="releasebadge" aria-label="Current build version">v11.5</span>')||!html.includes('id="routeChip"')||!html.includes('Created by <b>Edon Kukaj</b>')||!html.includes('class="footer-version">v11.5</span>')) fail.push('Current live release identity is incomplete.');
...
if(!html.includes('data-palcat="Premium"')||!script.includes("id:'premium-diffusion'")||!script.includes("id:'premium-parallel'")||!script.includes("id:'premium-rfpower'")||!script.includes("id:'premium-gradient'")) fail.push('Premium Quick Console discovery is incomplete.');
...
if(!script.includes("const PREMIUM_ACCESS_MODE='preview-only'")||!script.includes("premium_membership")||!script.includes("premium_diffusion")||!script.includes("premium_parallel")||!script.includes("premium_rfpower")||!script.includes("premium_gradient")) fail.push('Stable Premium product-key contract is incomplete.');
...
console.log('MR Command Center v11.5 Gradient Encoding Concepts Premium Preview validation passed.');
