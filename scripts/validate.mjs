...
const requiredIds=[
  ...
  'labContinuity','labContinuityTitle','labContinuityMeta','parameterLens','parameterReference','presetList','presetSearch','comparisonHistoryList',
...
if(!sw.includes("mrcc-v6.0.0")) fail.push('Service worker cache marker is not v6.0.0.');
...
if(!readme.includes('v6.0 — Lab Continuity')||!readme.includes('parameter reasoning workspace')) fail.push('README is stale.');
...
console.log('MR Command Center v6.0 Lab Continuity validation passed.');
